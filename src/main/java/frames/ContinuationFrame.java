 ...
 * Any number of CONTINUATION frames can be sent, as long as the preceding frame is on the same stream and is a
 * HEADERS, PUSH_PROMISE, or CONTINUATION frame without the END_HEADERS flag set.
 * <p>
 * +---------------------------------------------------------------+
 ...
 * identifier field is 0x0, the recipient MUST respond with a connection error (Section 5.4.1) of type PROTOCOL_ERROR.
 * <p>
